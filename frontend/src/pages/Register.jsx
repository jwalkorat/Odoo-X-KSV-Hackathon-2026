...
const Register = () => {
  ...
  return (
    <div class="min-h-screen flex items-center justify-center p-6 bg-slate-950">
      {/* Space Aura Glows */}
      <div class="absolute w-96 h-96 rounded-full bg-violet-600/5 blur-[120px] top-1/4 left-1/4 -z-10"></div>
      <div class="absolute w-96 h-96 rounded-full bg-cyan-500/5 blur-[120px] bottom-1/4 right-1/4 -z-10"></div>

      <div class="w-full max-w-2xl bg-slate-900/40 border border-violet-500/15 backdrop-blur-2xl rounded-2xl p-8 shadow-2xl my-8">
        
        {/* Back navigation */}
        <Link to="/login" class="inline-flex items-center space-x-2 text-xs font-mono text-slate-500 hover:text-cyan-400 transition mb-6">
        ...
        <div class="text-center mb-6">
          <div class="inline-flex bg-gradient-to-tr from-violet-600 to-cyan-400 p-2.5 rounded-2xl shadow-glow-cyan mb-3">
          ...
          <p class="text-xs text-slate-400 font-mono tracking-widest mt-1">UPLINK ENROLLMENT CONSOLE</p>
        </div>

        {/* Messages */}
        {error && (
          <div class="mb-6 flex items-center space-x-3 p-3 rounded-lg bg-red-950/20 border border-red-500/20 text-red-400 text-xs font-mono">
        ...
        {success && (
          <div class="mb-6 flex items-center space-x-3 p-3 rounded-lg bg-emerald-950/20 border border-emerald-500/20 text-emerald-400 text-xs font-mono">
            <Terminal class="w-4 h-4 shrink-0 animate-pulse" />
            <span>{success}</span>
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} class="space-y-6">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-2 bg-slate-950/60 border border-violet-500/15 rounded-lg text-slate-200 text-sm focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 font-mono placeholder-slate-700"
                required
              />
            </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <input
                  ...
                  class="w-full pl-10 pr-4 py-2 bg-slate-950/60 border border-violet-500/15 rounded-lg text-slate-200 text-sm focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 font-mono placeholder-slate-700"
                  required
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div class="relative">
                ...
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  class="w-full pl-10 pr-4 py-2.5 bg-slate-950/80 border border-violet-500/15 rounded-lg text-slate-200 text-xs focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 font-mono appearance-none"
                >
          ...
          <div>
            ...
            <textarea
              ...
              class="w-full px-4 py-2.5 bg-slate-950/60 border border-violet-500/15 rounded-lg text-slate-200 text-sm focus:outline-none focus:border-cyan-400 focus:ring-1 focus:ring-cyan-400 font-mono placeholder-slate-700 resize-none"
            ></textarea>
          </div>
