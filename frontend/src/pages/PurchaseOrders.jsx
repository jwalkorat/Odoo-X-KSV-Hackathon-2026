    ...
    <div className="space-y-6">
      ...
      <section className="grid grid-cols-1 gap-4 lg:grid-cols-5">
        <div className="glass-panel rounded-xl border border-cyan-500/20 p-5 lg:col-span-2">
          <p className="font-mono text-xs uppercase tracking-[0.28em] text-cyan-300">Supply chain console</p>
          ...
          {selected ? (
            <>
              <div className="border-b border-violet-500/10 pb-4">
                <span className={`inline-block rounded-full px-2.5 py-0.5 font-mono text-xs uppercase mb-2 ${getStatusBadgeClass(selected.status)}`}>
                  {selected.status}
                </span>
              ...
              <div className="rounded-lg border border-cyan-500/20 bg-cyan-500/10 p-4">
                <span className="font-mono text-xs uppercase tracking-widest text-cyan-300">Order Value</span>
