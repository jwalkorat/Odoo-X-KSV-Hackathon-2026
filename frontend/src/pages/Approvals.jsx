    ...
    <div className="space-y-6">
      ...
      <section className="grid grid-cols-1 gap-4 lg:grid-cols-5">
        <div className="glass-panel rounded-xl border border-cyan-500/20 p-5 lg:col-span-2">
          <p className="font-mono text-[10px] uppercase tracking-[0.28em] text-cyan-300">Manager deck</p>
            ...
            {loading ? (
              ...
              approvals.map((app) => (
                ...
                >
                  ...
                  <div>
                    <span className={`inline-block rounded-full px-2.5 py-0.5 font-mono text-[10px] uppercase ${getStatusBadgeClass(app.status)}`}>
                      {app.status}
                    </span>
                  </div>
                </div>
          ...
          {selectedApproval ? (
            <div className="space-y-6">
              <div className="border-b border-violet-500/10 pb-4">
                <span className={`inline-block rounded-full px-2.5 py-0.5 font-mono text-[10px] uppercase mb-2 ${getStatusBadgeClass(selectedApproval.status)}`}>
              ...
              <div className="space-y-4">
                <div className="rounded-lg border border-cyan-500/20 bg-cyan-500/10 p-4">
                  <span className="font-mono text-[9px] uppercase tracking-widest text-cyan-300">Quote Value</span>
                ...
                <div className="space-y-2.5 text-xs text-slate-300">
                  ...
                  {selectedApproval.notes && (
                    <div className="mt-3 bg-slate-900/50 rounded-lg p-3 border border-slate-800">
                      <span className="font-mono text-[9px] uppercase tracking-wider text-slate-500 block mb-1">Vendor Note</span>
                  ...
                  <div className="rounded-lg bg-slate-900/60 border border-slate-800 p-3.5 space-y-2">
                    ...
                    {selectedApproval.remarks && (
                      <div className="pt-2 border-t border-slate-800 mt-2">
                        <span className="text-[9px] font-mono uppercase text-slate-500 block mb-1">Resolution Remarks</span>
