    ...
    <div className="space-y-6">
      <section className="grid grid-cols-1 gap-4 lg:grid-cols-4">
        <div className="glass-panel rounded-xl border border-cyan-500/20 p-5 lg:col-span-2">
          <p className="font-mono text-xs uppercase tracking-[0.28em] text-cyan-300">Vendor registry</p>
              ...
              {selectedVendor ? (
                <div className="space-y-5">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <span className={`rounded-full px-2.5 py-1 font-mono text-xs uppercase ${getStatusBadgeClass(selectedVendor.status)}`}>{selectedVendor.status}</span>
                  </div>
                  <div className="rounded-lg border border-cyan-500/20 bg-cyan-500/10 p-4">
                    <p className="font-mono text-xs uppercase tracking-widest text-cyan-300">Vendor rating</p>
